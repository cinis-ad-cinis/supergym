...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: addTrainersSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var swiperTrainersList = document.querySelector('.trainers__list');
var swiperTrainersButtons = document.querySelectorAll('.trainers__button');
var addTrainersSwiper = function addTrainersSwiper() {
  ...
  if (swiperTrainersButtons || swiperTrainersList) {
    swiperTrainersButtons.forEach(function (el) {
      return el.classList.remove('trainers__button--no-js');
    });
