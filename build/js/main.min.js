...
window.addEventListener('DOMContentLoaded', function () {
  ...
  setupVideo(vid);
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["addTrainersSwiper"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["addReviewsSwiper"])();
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_2__["removeClasses"])();
...
var tabsContainer = document.querySelector('.membership__tabs');
var tabs = document.querySelectorAll('.membership__list');
...
tabButtons.forEach(function (item) {
  item.addEventListener('click', function (evt) {
    evt.preventDefault();
    var id = evt.target.getAttribute('data-button');
    var currentTab = document.querySelector("[data-tab='".concat(id, "']"));
    tabButtons.forEach(function (elem) {
      return elem.classList.remove('membership__button--active');
    });
    tabs.forEach(function (elem) {
      return elem.classList.remove('membership__list--active');
    });
...
/*!******************************!*\
  !*** ./js/modules/slider.js ***!
  \******************************/
/*! exports provided: addTrainersSwiper, addReviewsSwiper, removeClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addTrainersSwiper", function() { return addTrainersSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addReviewsSwiper", function() { return addReviewsSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "removeClasses", function() { return removeClasses; });
/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! swiper */ "../node_modules/swiper/swiper.esm.js");

var swiperTrainers = document.querySelectorAll('.trainers__swiper');
var swiperReviews = document.querySelectorAll('.reviews__swiper');
var swiperLists = document.querySelectorAll('.swiper-wrapper');
var swiperButtons = document.querySelectorAll('[data-swiper-button]');
var addTrainersSwiper = function addTrainersSwiper() {
  if (!swiperTrainers) {
    return;
  }
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.trainers__swiper', {
...
var addReviewsSwiper = function addReviewsSwiper() {
  if (!swiperReviews) {
    return;
  }
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.reviews__swiper', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__["Navigation"]],
    direction: 'horizontal',
    slidesPerView: 1,
    watchOverflow: true,
...
var removeClasses = function removeClasses() {
  ...
  swiperLists.forEach(function (el) {
    return el.classList.remove('no-js');
  });
};
